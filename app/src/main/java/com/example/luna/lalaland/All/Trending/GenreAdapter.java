...
public class GenreAdapter extends RecyclerView.Adapter<GenreAdapter.MyViewHolder> {
    ...
    int resource;
    private GenreAdapterListener genreAdapterListener; //인터페이스

    //원래 있떤 것
    public GenreAdapter(Context mCtx, List<Broadcast> broadcastList, GenreAdapterListener genreAdapterListener) {
        this.mCtx = mCtx;
...
//    }//
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.genre_list, parent, false);
        ...
        if(this.broadcastList == null) {
            ...
            final DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return GenreAdapter.this.broadcastList.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return GenreAdapter.this.broadcastList.get(oldItemPosition)
                            == broadcastList.get(newItemPosition);
                }

                @Override
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    Broadcast broadcast = GenreAdapter.this.broadcastList.get(oldItemPosition);
                    return true;
                }
            });//callback
            this.broadcastList = broadcastList;
        ...
        public MyViewHolder(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    genreAdapterListener.onBroadcastSelected(broadcastList.get(getAdapterPosition()));
                }//onClick
            });//setOnClickListener
